<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HistorialBusqueda.aspx.cs" Inherits="Inmobiliario.Consultas.HistorialBusqueda" MasterPageFile="~/Master.master" %>
            ...
            <tr>
                <td> 
                    ...
                    <asp:GridView runat="server" ID="DGCp" AllowPaging="false"
                        CellPadding="4" ForeColor="#333333" CellSpacing="2" HorizontalAlign="Justify"
                        DataKeyNames="ID,TipoConsulta,metraje,costo,usuario,ParametroDescripcion,LugarDescripcion,IDESTADO"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TipoConsulta" HeaderText="TipoConsulta" ReadOnly="True" Visible="true"  > <ItemStyle Wrap="False" /> </asp:BoundField>
                            ...
                            <asp:BoundField DataField="ParametroDescripcion" HeaderText="ParametroDescripcion" >
                            <ItemStyle Wrap="False" />
                            </asp:BoundField>
 
                            <asp:BoundField DataField="LugarDescripcion" HeaderText="LugarDescripcion" >
                            </asp:BoundField>
