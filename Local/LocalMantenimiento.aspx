<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LocalMantenimiento.aspx.cs" Inherits="Inmobiliario.Local.LocalMantenimiento" MasterPageFile="~/Master.master" %>
        ...
        <table border="1">
            ...
            <tr>
                <td>
                    <table border="1">
                       ...
                       <tr>
                                ...
                                <td class="auto-style5"> 
                                    ...
                                    <asp:Label ID="lblTipoLocal" runat="server" Text="" ForeColor="Red" Font-Bold="True"></asp:Label>   
                                </td>
                       ...
                       <tr>
                                ...
                                <td class="auto-style5"> 
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:DropDownList ID="ddlTipoVia" Width="170px" runat="server" CssClass="clasico" BackColor="#ffff99" ></asp:DropDownList>

                                                <asp:TextBox ID="txtDireccion" Width="253px" runat="server" CssClass="clasico" BackColor="#ffff99" Height="16px"  ></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtNumero" Width="50px" runat="server" CssClass="clasico" BackColor="#ffff99" Height="16px"  ></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblDireccion" runat="server" Text="" ForeColor="Red" Font-Bold="True"></asp:Label>   
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <tr>
                            ...
                            <td class="auto-style5"> 
                                    ...
                                    <br />
                                    <asp:Image ID="Image1" runat="server" Height="153px" Width="330px"  onchange="showimagepreview(this)" />   
                            </td>
                        </tr>
                        <tr>
                            <td > <b> Foto 2</b> </td>
                            <td class="auto-style5"> 
                                    ...
                                    <br />
                                    <asp:Image ID="Image2" runat="server" Height="146px" Width="324px" />                               
                            </td>
                        </tr>
                    ...
                    <tr>
                                <td>
                                    <b> PARAMETROS DEL LOCAL </b> 
                                </td>
                                <td class="auto-style5">
                                    <table>
                                        <tr>
                                            <td> Seleccione Parametro </td>
                                            <td> Cantidad </td>
                                            <td> Costo </td>
                                        </tr>
                                        <tr>
                    ...
                    <tr>
                                <td>
                                    <b> RUBROS DEL LOCAL </b> 
                                </td>
                                <td class="auto-style5">
                                    <table>
                                        <tr>
                                            <td> Seleccione el rubro</td>
                                           
                                        </tr>
                                        <tr>
                                            <td>  
                                                <asp:DropDownList ID="ddlRubro" Width="336px" runat="server" CssClass="clasico" BackColor="#ffff99" AutoPostBack="true"></asp:DropDownList>
                                            </td>
                                            
                                            <td>
                                                <asp:Button ID="btnAgregarRubro" runat="server" Text="Agregar" OnClick="btnAgregarRubro_Click"  />
                ...
                <td>
                    <table style="margin-top: 0px">
                        <tr>
                            <td colspan="2"> <center> LISTA DE LOCALES </center> </td>
                        </tr>
                        ...
                        <td style="margin-left: 40px">            
                            <asp:GridView  runat="server" ID="DG"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="IdLocal" HeaderText="ID" ReadOnly="True" Visible="true" ItemStyle-Width="1" ><ItemStyle Width="1px"></ItemStyle>
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="RutaFoto2" HeaderText="RutaFoto2" ReadOnly="True" Visible="true"  > <ItemStyle Wrap="False" /> </asp:BoundField>
                                     ...
                                     <asp:BoundField DataField="IdTipoLocal" HeaderText="" ReadOnly="True" Visible="true"  >
                                                                                  <ItemStyle ForeColor="White"  BorderStyle="None"/>
                                     </asp:BoundField>
                                    <asp:BoundField DataField="IdTipoVia" HeaderText="" ReadOnly="True" Visible="true"  > 
                                                                                 <ItemStyle ForeColor="White"  BorderStyle="None"/>
                                    </asp:BoundField>
                            ...
                            <asp:GridView  runat="server" ID="DGOficinaParametros"
                                CellPadding="4" ForeColor="#333333" CellSpacing="2" HorizontalAlign="Justify"
                                AutoGenerateColumns="False"  BorderStyle="None" Width="228px" Font-Size="10pt" style="margin-right: 0px"  Height="107px">
                            ...
                            <BR />
                            <asp:GridView  runat="server" ID="DGRubro"
                                CellPadding="4" ForeColor="#333333" CellSpacing="2" HorizontalAlign="Justify"
                                AutoGenerateColumns="False"  BorderStyle="None" Width="228px" Font-Size="10pt" style="margin-right: 0px"  Height="107px">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Descripcion" HeaderText="Rubro" ReadOnly="True" Visible="true" ItemStyle-Width="1" ><ItemStyle Width="1px" Wrap="False"></ItemStyle>
                                    </asp:BoundField>
