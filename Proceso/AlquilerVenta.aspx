<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlquilerVenta.aspx.cs" Inherits="Inmobiliario.Proceso.AlquilerVenta" MasterPageFile="~/Master.master"  %>
                            ...
                            <table  border="1">
                                <thead>
                                    <tr>
                                        ...
                                        <th> CLIENTE </th>
                                        <th class="auto-style5"> FECHA INICIO </th>
                                        <th class="auto-style5"> FECHA FIN </th>
                                    </tr>
                                </thead>
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtIdPropiedad" runat="server" Width="80" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlTipoOperacion" runat="server"></asp:DropDownList>  
                                        <asp:Label ID="lblTipoOperacion" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlCliente" runat="server"></asp:DropDownList>  
                                        <asp:Label ID="lblCliente" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                    </td>                        
                                    <td >
                                        <asp:TextBox ID="txtFechaIni" runat="server" Width="69px" Enabled="false" Height="16px"></asp:TextBox>
                                        <asp:ImageButton ID="btnCalendario2" runat="server" Height="20px" ImageUrl="~/Imagenes/Calendario.jpg" OnClick="btnCalendario2_Click" />
                                        ...
                                        <asp:Label ID="lblFechaIni" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>

                                    </td>

                                    <td class="auto-style6">
                                        <asp:TextBox ID="txtFechaFin" runat="server" Width="69px" Enabled="false" Height="16px"></asp:TextBox>
                                        <asp:ImageButton ID="btnCalendario3" runat="server" Height="20px" ImageUrl="~/Imagenes/Calendario.jpg" OnClick="btnCalendario3_Click" />
                                        <asp:Calendar ID="Calendar3" runat="server" Visible="False" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#663399" Height="200px" OnSelectionChanged="Calendar3_SelectionChanged" ShowGridLines="True" Width="220px">
                                                <DayHeaderStyle BackColor="#FFCC66" Font-Bold="True" Height="1px" />
                                                <NextPrevStyle Font-Size="9pt" ForeColor="#FFFFCC" />
                                                <OtherMonthDayStyle ForeColor="#CC9966" />
                                                <SelectedDayStyle BackColor="#CCCCFF" Font-Bold="True" />
                                        ...
                                        <asp:Label ID="lblFechaFin" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>

                                    </td>
                                    <td>
                                        <asp:ImageButton ID="ImageButton2" runat="server" BorderStyle="Solid" BorderWidth="1px" ToolTip="Alquilar" Style="text-align: center; " ImageUrl="~/Imagenes/Agregar01.jpg" OnClick="ImageButton2_Click" Height="27px" Width="28px" />
                                    </td>
                                    <td>
                                        <asp:ImageButton ID="ImageButton3" runat="server" BorderStyle="Solid" BorderWidth="1px" ToolTip="Cancelar" Style="text-align: center; " ImageUrl="~/Imagenes/Eliminar.jpg" OnClick="ImageButton3_Click" Height="28px" Width="30px"  />
                                    </td>
                                </tr>
                            </table>
